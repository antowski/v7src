...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	Если МассивБинарныхФайлов.Количество() = 0 Тогда
		Возврат 0;
	КонецЕсли;

	ПоказыватьПрогресс = Истина;

	Если ПоказыватьПрогресс Тогда
		ПрогрессБар = Новый ПрогрессБар();
		ПрогрессБар.Начать(МассивБинарныхФайлов.Количество(), "Прогресс распаковки ");
	КонецЕсли;
    ...
    Для Каждого БинарныйФайл Из МассивБинарныхФайлов Цикл
		...
		Перекодировщик.ПерекодироватьКаталог(КаталогИсходниковТекФайла, ".1s,.frm,.ord,.txt,.mdp");
